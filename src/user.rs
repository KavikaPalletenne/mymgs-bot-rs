...
// Create
pub async fn create_user_by_id(id: i64, synergetic_user_id: i32, mgs_email: &str, mgs_password: &str, pool: &Pool<Postgres>) -> Result<()> {
    sqlx::query!(
...
// Update
pub async fn update_user_by_id(id: i64, synergetic_user_id: i32, mgs_email: &str, mgs_password: &str, pool: &Pool<Postgres>) -> Result<()> {
    sqlx::query!(
